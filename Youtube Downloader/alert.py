...
#        self.retranslateUi(Alert)
    ...
    def retranslateUi(self, Alert, text=["Dialog", "Alert!", "Entered wrong Url OR video doesnot exisit", "If keeps happening. Please update to latest version"]):        
        Alert.setWindowTitle(QCoreApplication.translate("Alert", text[0], None))
        self.label.setText(QCoreApplication.translate("Alert", text[1], None))
        self.label_2.setText(QCoreApplication.translate("Alert", text[2], None))
        self.label_3.setText(QCoreApplication.translate("Alert", text[3], None))
    # retranslateUi
